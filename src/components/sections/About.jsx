...
export const About = () => {
    ...
    const backendSkills = ['Python', "NodeJs"]
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                        <div className="p-6 rounded-xl border-white/10 border hover:translate-y-1 transition-all">
                            ...
                            <ul className="list-disc list-inside text-gray-300 space-y">
                                <li><strong>B.E in Computer Science</strong> Sahyadri College of Engineering and Management (2023-27)</li>
                        ...
                        <div className="p-6 rounded-xl border-white/10 border hover:translate-y-1 transition-all">
                            ...
                            <div className="space-y-4 text-gray-300">
                                <div>
                                    ...
                                    <p>Developed actively an webiste</p>
                                </div>
